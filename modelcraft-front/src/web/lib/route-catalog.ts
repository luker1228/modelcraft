...
export const ROUTE_CATALOG: RouteCatalogEntry[] = [
  ...
  },
  {
    ...
    title: '数据库管理',
    description: '注册项目使用的 MySQL 数据库，设置访问模式（托管/自建），触发同步将数据库表导入为数据模型',
    keywords: ['数据库', '数据库管理', '注册数据库', '数据库注册', '注册', '数据库同步', '同步数据库', 'MySQL', '托管', '自建'],
    examples: [
      '我想注册 demo_pm',
      '帮我把 test_db 注册进来',
      '去数据库管理页',
  ...
  },
  {
    ...
    title: '项目设置',
    description: '修改项目基本信息、归档或删除项目；配置数据库集群连接（MySQL 主机、端口、账号密码），是使用数据库注册功能的前提',
  ...
  {
    routeTemplate: '/org/:orgName/api-tokens',
    title: 'API Token',
