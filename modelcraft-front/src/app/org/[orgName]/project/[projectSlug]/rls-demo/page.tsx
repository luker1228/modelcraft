      ...
      <div className="mx-auto w-full max-w-[1600px] px-6 pb-12 pt-10 xl:px-10">
        <section className="mb-10 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center">
            <Button variant="outline" size="sm" className="h-[26px] w-full justify-start text-xs lg:w-[180px]" disabled>
              <span className="text-muted-foreground">数据库</span>
              <span className="font-mono text-foreground">{databaseName}</span>
            </Button>
            ...
            <CardHeader className="space-y-3">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button variant="outline" size="sm" className="h-[26px] text-xs" disabled>
                    关闭 RLS
                  </Button>
        ...
        <SheetContent side="right" className="w-[760px] overflow-y-auto p-0 sm:max-w-[860px]">
          <div className="p-6">
            <SheetHeader>
              ...
              <SheetDescription>
                数据库: <span className="font-mono">{databaseName}</span> / 模型:{' '}
