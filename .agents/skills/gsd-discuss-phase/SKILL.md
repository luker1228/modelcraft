...
Read and execute `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/workflows/discuss-phase.md` end-to-end.
