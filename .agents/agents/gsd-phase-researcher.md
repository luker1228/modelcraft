...
@/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/thinking-models-research.md
...
```bash
node "/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
