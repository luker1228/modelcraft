...
<required_reading>
Read `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
