...
**Then** the middleware extracts `projectName` = "ecommerce" from route parameter `:projectName`
...
**Given** a request for projectName = "ecommerce"
**When** the middleware processes the request
...
**Given** a request for projectName = "unknown-project"
...
**Then** the middleware is applied to all routes matching `/graphql/:projectName/*`
...
**And** a request to projectName = "default"
**When** the middleware processes the request
