# modeldesign-repair Specification

## Purpose
TBD - created by archiving change add-model-repair-api. Update Purpose after archive.
## Requirements
...
- **WHEN** a model exists in the platform database with model_id, project_name, cluster_name, database_name, and model_name
...
- **THEN** it includes `RepairModelInput` with fields:
  - `projectName: ID!` - Project identifier
