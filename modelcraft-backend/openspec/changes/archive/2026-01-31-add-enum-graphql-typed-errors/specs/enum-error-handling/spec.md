...
**When** client queries enum with projectId "ecommerce" and name "Status"
...
**When** client creates a new enum with projectId "ecommerce" and name "Status"
...
**When** client creates an enum with projectId "invalid-project"
...
**When** client deletes the enum with projectId "ecommerce" and name "Status"
...
None - This change is purely additive. No existing requirements are modified.
