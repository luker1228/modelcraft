...
func TestIsValidProjectSlug(t *testing.T) {
	tests := []struct {
		...
		{"too short", "ab", false},
		{"too long", "abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyzabc", false},
		...
		{"maximum length", "abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyzab", true},
	}
