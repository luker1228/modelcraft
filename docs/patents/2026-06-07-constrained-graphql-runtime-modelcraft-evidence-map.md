...
| Dynamic runtime schema generation | `ai-metadata/backend/design/core-principles.md "### 2. 双 GraphQL 入口：设计态静态 Schema + 运行态动态 Schema"` | Direct project evidence that runtime schema generation is dynamic rather than fixed at design time. |
