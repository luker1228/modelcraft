...
> **文章设计稿** — 2026-06-10
> 主题句：一个人，8个月，从0到1走完一个完整产品的全链路
> 叙事方式：问题驱动式，每层从一个具体困境开始
> 目标读者：外部技术社区（掘金/个人博客）
> 目标字数：5000-7000字
...
去年十月，我在公司内网看到一篇文章，标题大概是「我用 AI 三天写了一个小程序」。

我当时的第一反应不是羡慕，是心虚。

因为我已经烧了三个月、几千块钱，什么都没做出来。

说起来很不体面——我不是没有想法，是想法太多了。每次坐下来准备动手，就开始想：「这个设计对吗？」「那个方案我考虑清楚了吗？」「后端架构要不要先想清楚再写前端？」然后什么都没写，又去调研了三天。

我在这个领域做了五年，深度参与过低代码数据模型和云数据库的设计。

这五年里，有一件事一直压在心里：**我总觉得这件事可以做得更好。**

不是说我们做的不好——而是每次做完一个版本，我都能清楚地看到它的天花板在哪。数据模型的抽象够不够深？权限边界划得够不够干净？接口设计对 AI 友不友好？这些问题，我心里都有答案，只是从来没有机会完整地验证一遍。

所以去年十月，我给自己一个问题：**如果让我从零开始，设计一个低代码数据引擎，我会怎么做？**

然后就开始烧钱了。

前三个月，几千块，什么都没做出来。想法太多了——每次坐下来准备动手，就开始想：「这个设计对吗？」「后端架构要不要先想清楚再写前端？」然后什么都没写，又去调研了三天。

直到有一天，我翻出一张旧工单：

> "你们的 DSL 文档我看了，但还是不知道这个字段支持哪些查询操作符。"

这张工单是两年前的。处理完之后我随手存了下来，也不知道为什么。

那天盯着这行字，我忽然想到：**如果 DSL 能自己解释自己，就不需要文档了。**
