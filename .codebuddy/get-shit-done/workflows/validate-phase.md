...
```
Task(
  prompt="Read /data/home/lukemxjia/modelcraft/.codebuddy/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/templates/VALIDATION.md`
