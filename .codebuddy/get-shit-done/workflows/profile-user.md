...
Key references:
- @/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/ui-brand.md (display patterns)
- @/data/home/lukemxjia/modelcraft/.codebuddy/agents/gsd-user-profiler.md (profiler agent definition)
- @/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/USER-PROFILE.md" "/data/home/lukemxjia/modelcraft/.codebuddy/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/user-profiling.md`
...
Reference: @/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /data/home/lukemxjia/modelcraft/.codebuddy/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /data/home/lukemxjia/modelcraft/.codebuddy/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /data/home/lukemxjia/modelcraft/.codebuddy/CLAUDE.md"
...
```bash
BACKUP_PATH="/data/home/lukemxjia/modelcraft/.codebuddy/USER-PROFILE.backup.md"
```
...
Your profile:    /data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /data/home/lukemxjia/modelcraft/.codebuddy/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /data/home/lukemxjia/modelcraft/.codebuddy/CLAUDE.md
```
