...
```markdown
Read /data/home/lukemxjia/modelcraft/.codebuddy/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /data/home/lukemxjia/modelcraft/.codebuddy/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /data/home/lukemxjia/modelcraft/.codebuddy/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /data/home/lukemxjia/modelcraft/.codebuddy/agents/gsd-eval-planner.md for instructions.
