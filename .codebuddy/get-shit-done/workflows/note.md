...
- **Global scope**: `/data/home/lukemxjia/modelcraft/.codebuddy/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/data/home/lukemxjia/modelcraft/.codebuddy/notes/`)
...
2. Glob `/data/home/lukemxjia/modelcraft/.codebuddy/notes/*.md` (if directory exists) — global notes
...
Global (/data/home/lukemxjia/modelcraft/.codebuddy/notes/):
...
2. **No `.planning/`**: Falls back to global `/data/home/lukemxjia/modelcraft/.codebuddy/notes/` — works in any directory
