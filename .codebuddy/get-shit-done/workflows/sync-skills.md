...
INSTALL_JS_GLOBAL="/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
