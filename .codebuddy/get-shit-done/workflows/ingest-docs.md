...
```bash
INIT=$(node "/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/bin/gsd-tools.cjs" commit \
