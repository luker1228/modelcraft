...
```bash
INIT=$(node "/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/templates/spec.md.
