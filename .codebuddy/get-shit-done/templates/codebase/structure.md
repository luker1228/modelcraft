...
- Usage: Reference from command with `@/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /data/home/lukemxjia/modelcraft/.codebuddy/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /data/home/lukemxjia/modelcraft/.codebuddy/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
