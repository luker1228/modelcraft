...
<!-- For checkpoint task examples and patterns, see @/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/checkpoints.md -->
...
See `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/data/home/lukemxjia/modelcraft/.codebuddy/get-shit-done/workflows/verify-phase.md` for verification logic.
